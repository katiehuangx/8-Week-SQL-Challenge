...
This repository serves as the solution for the 8 case studies provided in the **[#8WeekSQLChallenge](https://8weeksqlchallenge.com)**. It showcases my ability to tackle various SQL challenges and demonstrates my proficiency in SQL query writing and problem-solving skills.

A special thanks @DataWithDanny for creating these insightful and engaging SQL case studies! 👋🏻 
